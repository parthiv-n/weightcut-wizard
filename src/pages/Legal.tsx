...
function PrivacyPolicy() {
  return (
    <div>
      ...
      <P>
        WeightCut Wizard ("we", "our", "the app") is operated by Pratik Rai. This policy explains
      ...
      <P>
        WeightCut Wizard is not intended for users under 17 years of age. We do not knowingly
...
function TermsOfService() {
  return (
    <div>
      ...
      <P>
        By using WeightCut Wizard ("the app"), you agree to these terms. If you do not agree,
        do not use the app.
      </P>

      <SectionTitle>1. Service Description</SectionTitle>
      <P>
        WeightCut Wizard is a fitness and nutrition tracking application designed for combat sport
      ...
      <P>
        <strong className="text-foreground">WeightCut Wizard is not a medical device and does not provide medical advice.</strong>{" "}
      ...
      <P>
        To the maximum extent permitted by law, WeightCut Wizard and its developers are not liable
