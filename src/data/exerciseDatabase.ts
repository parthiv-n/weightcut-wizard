...
export const EXERCISE_DATABASE: SeedExercise[] = [
  ...
  { name: "Dumbbell Overhead Tricep Extension", category: "push", muscle_group: "triceps", equipment: "dumbbell", is_bodyweight: false },
  // Back (Pull)
  ...
  { name: "Trap Bar Deadlift", category: "pull", muscle_group: "back", equipment: "barbell", is_bodyweight: false },
  { name: "Meadows Row", category: "pull", muscle_group: "back", equipment: "barbell", is_bodyweight: false },
  { name: "Chest-Supported Row", category: "pull", muscle_group: "back", equipment: "dumbbell", is_bodyweight: false },
  { name: "Inverted Row", category: "pull", muscle_group: "back", equipment: "bodyweight", is_bodyweight: true },
  // Biceps (Pull)
  ...
  { name: "Dumbbell Split Squat", category: "legs", muscle_group: "quads", equipment: "dumbbell", is_bodyweight: false },
  { name: "Safety Bar Squat", category: "legs", muscle_group: "quads", equipment: "barbell", is_bodyweight: false },
  { name: "Zercher Squat", category: "legs", muscle_group: "quads", equipment: "barbell", is_bodyweight: false },
  { name: "Sissy Squat", category: "legs", muscle_group: "quads", equipment: "bodyweight", is_bodyweight: true },
  { name: "Step-Up", category: "legs", muscle_group: "quads", equipment: "dumbbell", is_bodyweight: false },
  { name: "Reverse Lunge", category: "legs", muscle_group: "quads", equipment: "dumbbell", is_bodyweight: false },
  ...
  { name: "Single-Leg Romanian Deadlift", category: "legs", muscle_group: "hamstrings", equipment: "dumbbell", is_bodyweight: false },
  { name: "Glute-Ham Raise", category: "legs", muscle_group: "hamstrings", equipment: "machine", is_bodyweight: false },
  // Glutes (Legs)
  ...
  { name: "Box Jump", category: "legs", muscle_group: "quads", equipment: "bodyweight", is_bodyweight: true },
  { name: "Depth Jump", category: "legs", muscle_group: "quads", equipment: "bodyweight", is_bodyweight: true },
  { name: "Jump Squat", category: "legs", muscle_group: "quads", equipment: "bodyweight", is_bodyweight: true },
  { name: "Broad Jump", category: "legs", muscle_group: "quads", equipment: "bodyweight", is_bodyweight: true },
  { name: "Split Squat Jump", category: "legs", muscle_group: "quads", equipment: "bodyweight", is_bodyweight: true },
  { name: "Plyo Push-Up", category: "push", muscle_group: "chest", equipment: "bodyweight", is_bodyweight: true },
  { name: "Medicine Ball Slam", category: "full_body", muscle_group: "full_body", equipment: "none", is_bodyweight: false },
  { name: "Medicine Ball Throw", category: "full_body", muscle_group: "full_body", equipment: "none", is_bodyweight: false },
  { name: "Tuck Jump", category: "legs", muscle_group: "quads", equipment: "bodyweight", is_bodyweight: true },
  { name: "Skater Jump", category: "legs", muscle_group: "glutes", equipment: "bodyweight", is_bodyweight: true },
  // Full Body
  { name: "Clean and Press", category: "full_body", muscle_group: "full_body", equipment: "barbell", is_bodyweight: false },
  { name: "Power Clean", category: "full_body", muscle_group: "full_body", equipment: "barbell", is_bodyweight: false },
  { name: "Hang Clean", category: "full_body", muscle_group: "full_body", equipment: "barbell", is_bodyweight: false },
  { name: "Snatch", category: "full_body", muscle_group: "full_body", equipment: "barbell", is_bodyweight: false },
  { name: "Clean and Jerk", category: "full_body", muscle_group: "full_body", equipment: "barbell", is_bodyweight: false },
  { name: "Kettlebell Swing", category: "full_body", muscle_group: "full_body", equipment: "kettlebell", is_bodyweight: false },
  { name: "Kettlebell Clean", category: "full_body", muscle_group: "full_body", equipment: "kettlebell", is_bodyweight: false },
  { name: "Kettlebell Snatch", category: "full_body", muscle_group: "full_body", equipment: "kettlebell", is_bodyweight: false },
  { name: "Turkish Get-Up", category: "full_body", muscle_group: "full_body", equipment: "kettlebell", is_bodyweight: false },
  { name: "Thruster", category: "full_body", muscle_group: "full_body", equipment: "barbell", is_bodyweight: false },
  { name: "Dumbbell Thruster", category: "full_body", muscle_group: "full_body", equipment: "dumbbell", is_bodyweight: false },
  { name: "Burpee", category: "full_body", muscle_group: "full_body", equipment: "bodyweight", is_bodyweight: true },
  { name: "Battle Ropes", category: "full_body", muscle_group: "full_body", equipment: "none", is_bodyweight: false },
  { name: "Sled Push", category: "full_body", muscle_group: "full_body", equipment: "machine", is_bodyweight: false },
  { name: "Sled Pull", category: "full_body", muscle_group: "full_body", equipment: "machine", is_bodyweight: false },
  // Cardio
  { name: "Assault Bike", category: "cardio", muscle_group: "cardio", equipment: "machine", is_bodyweight: false },
  { name: "Rowing Machine", category: "cardio", muscle_group: "cardio", equipment: "machine", is_bodyweight: false },
  { name: "Ski Erg", category: "cardio", muscle_group: "cardio", equipment: "machine", is_bodyweight: false },
  { name: "Stairmaster", category: "cardio", muscle_group: "cardio", equipment: "machine", is_bodyweight: false },
  { name: "Jump Rope", category: "cardio", muscle_group: "cardio", equipment: "none", is_bodyweight: true },
];
