      ...
      <Sheet open={open} onOpenChange={onOpenChange}>
        <SheetContent side="bottom" className="h-[80vh] rounded-t-3xl overflow-y-auto">
          ...
          >
            ...
            {(() => {
              ...
              return (
                <motion.div variants={staggerItem} className={`grid ${cols} gap-2 mt-4 mb-5`}>
                  {hasDuration && (
                    <div className="card-surface rounded-xl border border-border/50 text-center p-3">
            ...
            {/* Notes */}
            {session.notes && (
              <motion.div variants={staggerItem} className="mb-5 card-surface rounded-xl border border-border/50 p-3.5 text-sm text-muted-foreground">
                {session.notes}
              </motion.div>
            )}
            ...
            <div className="space-y-4">
              {session.exerciseGroups.map((group) => (
                ...
                >
                  ...
                  <div className="card-surface rounded-xl border border-border/50 overflow-hidden divide-y divide-border/15">
