      ...
      <SheetContent side="bottom" className="h-[80vh] rounded-t-3xl overflow-y-auto">
        ...
        >
            ...
            <motion.div variants={staggerItem} className="space-y-2.5">
              ...
              <div className="grid grid-cols-2 gap-2">
                {pr.max_weight_kg != null && pr.max_weight_kg > 0 && (
                  <div className="card-surface rounded-xl border border-border/50 p-3 space-y-1.5">
          ...
          <motion.div variants={staggerItem} className="space-y-2.5">
            ...
            <div className="card-surface rounded-xl border border-border/50 p-3">
          ...
          {sets.length > 0 && (
            <motion.div variants={staggerItem} className="space-y-2.5">
              ...
              <div className="card-surface rounded-xl border border-border/50 overflow-hidden divide-y divide-border/20">
